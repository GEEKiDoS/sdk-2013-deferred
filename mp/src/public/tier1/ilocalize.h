...
public:
    ...
    virtual void ConstructString( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) wchar_t * unicodeOutput,
    ...
    {
        if ( wchar_t* find = Find( token ) ) return find;
    ...
    static int ConvertANSIToUnicode( const char* ansi, OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) wchar_t* unicode,
    ...
    // Returns amount of characters that the *utf16 buffer contains, including null terminator, not size in bytes (which
    // would be multiply sizeof(wchar_t)).
    ...
    static int ConvertUnicodeToANSI( const wchar_t* unicode, OUT_Z_BYTECAP( ansiBufferSize ) char* ansi,
                                     int ansiBufferSize );
    ...
    template <typename T>
    static void ConstructString( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) T * unicodeOuput,
                                 int unicodeBufferSizeInBytes, const T* formatString, int numFormatParameters, ... )
    {
        va_list argList;
        va_start( argList, numFormatParameters );

        ConstructStringVArgsInternal( unicodeOuput, unicodeBufferSizeInBytes, formatString, numFormatParameters,
                                      argList );
    ...
    template <typename T>
    static void ConstructStringVArgs( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) T * unicodeOuput,
                                      int unicodeBufferSizeInBytes, const T* formatString, int numFormatParameters,
                                      va_list argList )
    {
        ConstructStringVArgsInternal( unicodeOuput, unicodeBufferSizeInBytes, formatString, numFormatParameters,
    ...
    template <typename T>
    static void ConstructStringArgs( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) T * unicodeOuput,
                                     int unicodeBufferSizeInBytes, const T* formatString, int numFormatParameters,
                                     const CLocalizedStringArg* argList )
    {
        ConstructStringArgsInternal( unicodeOuput, unicodeBufferSizeInBytes, formatString, numFormatParameters,
                                     argList );
    }

    template <typename T>
    static void ConstructString( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) T * unicodeOutput,
                                 int unicodeBufferSizeInBytes, const T* formatString, KeyValues* localizationVariables )
    {
        ConstructStringKeyValuesInternal( unicodeOutput, unicodeBufferSizeInBytes, formatString,
                                          localizationVariables );
    }

private:
    // internal "interface"
    static void ConstructStringVArgsInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) char* unicodeOutput,
                                              int unicodeBufferSizeInBytes, const char* formatString,
                                              int numFormatParameters, va_list argList );
    static void ConstructStringArgsInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) char* unicodeOutput,
                                             int unicodeBufferSizeInBytes, const char* formatString,
                                             int numFormatParameters, const CLocalizedStringArg* argList );
    static void ConstructStringVArgsInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) wchar_t * unicodeOutput,
                                              int unicodeBufferSizeInBytes, const wchar_t* formatString,
                                              int numFormatParameters, va_list argList );
    static void ConstructStringArgsInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) wchar_t * unicodeOutput,
                                             int unicodeBufferSizeInBytes, const wchar_t* formatString,
                                             int numFormatParameters, const CLocalizedStringArg* argList );

    static void ConstructStringKeyValuesInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) char* unicodeOutput,
                                                  int unicodeBufferSizeInBytes, const char* formatString,
                                                  KeyValues* localizationVariables );
    static void ConstructStringKeyValuesInternal( OUT_Z_BYTECAP( unicodeBufferSizeInBytes ) wchar_t * unicodeOutput,
                                                  int unicodeBufferSizeInBytes, const wchar_t* formatString,
                                                  KeyValues* localizationVariables );
};
...
{
public:
    template <typename U, std::enable_if_t<std::conjunction_v<std::is_integral<U>, std::is_unsigned<U>,
                                                              std::bool_constant<sizeof( U ) <= 4>>,
                                           int> = 0>
    CLocalizedStringArg( U value ) : CLocalizedStringArg( value, LOCCHAR( "%u" ) )
    {
    }
    template <typename U, std::enable_if_t<std::conjunction_v<std::is_integral<U>, std::is_unsigned<U>,
                                                              std::bool_constant<sizeof( U ) == 8>>,
                                           int> = 1>
    ...
    template <
        typename U,
        std::enable_if_t<
            std::conjunction_v<std::is_integral<U>, std::is_signed<U>, std::bool_constant<sizeof( U ) <= 4>>, int> = 2>
    ...
    template <
        typename U,
        std::enable_if_t<
            std::conjunction_v<std::is_integral<U>, std::is_signed<U>, std::bool_constant<sizeof( U ) == 8>>, int> = 3>
    ...
    template <typename U,
              std::enable_if_t<std::disjunction_v<std::is_same<U, char*>, std::is_same<U, const char*>>, int> = 6>
    CLocalizedStringArg( U pszValue ) : CLocalizedStringArg( pszValue, ___WIDECHAR_PRINT_FORMAT_ANSICHAR )
    {
    }
    template <typename U,
              std::enable_if_t<std::disjunction_v<std::is_same<U, wchar_t*>, std::is_same<U, const wchar_t*>>, int> = 7>
...
private:
    template <typename T>
    CLocalizedStringArg( T value, const locchar_t* loc_Format )
    {
...
public:
    ...
    CConstructLocalizedString( const locchar_t* loc_Format, T... args )
    {
        ...
        if ( loc_Format )
        {
            ...
            ::ILocalize::ConstructStringArgs( m_loc_Buffer, sizeof( m_loc_Buffer ), loc_Format, ARRAYSIZE( locArgs ),
                                              locArgs );
        }
    }
